...
const Webanimation = () => {
  return (
    <div className="w-full min-h-screen px-4 sm:px-6 md:px-10 py-14 bg-[#1E3A8A] text-white">

      {/* Top Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16">

        {/* Left Content */}
        <div className="text-center md:text-left md:ml-[40px] md:mt-[-50px]">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 leading-snug">
            Build Powerful{" "}
            <span className="text-yellow-400">Web Solutions</span>
          </h2>

          <p className="text-base sm:text-lg text-gray-200 leading-relaxed text-justify md:text-justify max-w-xl mx-auto md:mx-0">
From responsive design to dynamic backend systems, we build web solutions that are fast, modern, and scalable. Our expert team creates seamless user experiences using cutting-edge technologies. We focus on crafting robust websites with unique patterns and strategic architecture. Every project is tailored to meet your business goals with precision and efficiency.
        ...
        <div className="flex justify-center items-center">
          <img
            ...
            className="w-full max-w-sm sm:max-w-md rounded-xl"
          />
        </div>
      </div>
      ...
      <div className="text-center">
        <h3 className="text-3xl sm:text-4xl font-semibold text-yellow-400 mb-10">
          Technologies We Work With
        </h3>

        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-[1350px] mx-auto mb-8 md:ml-[40px]">
