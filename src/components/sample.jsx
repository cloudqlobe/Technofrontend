...
const Pmcontents = () => {
  return (
    <div className="min-h-screen w-full bg-white px-4 sm:px-6 md:px-12 py-10 overflow-hidden">
      <h1 className="text-2xl sm:text-3xl md:text-4xl text-center text-black lg:mb-20 mb-12 mt-10">
        Scalable{" "}
      ...
      {/* Section 1 */}
      <div className="grid md:grid-cols-2 items-center gap-8 mb-16 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col justify-center w-full md:w-[600px] md:ml-[57px]">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-default text-gray-800 mb-2">
            Efficient{" "}
            <span className="text-orange-500">Task & Workflow Management</span>
          </h2>

          <p className="text-gray-600 text-base sm:text-lg text-justify mt-6">
          ...
          <p className="text-gray-600 text-base sm:text-lg text-justify mt-4">
      ...
      {/* Section 2 */}
      <div className="grid md:grid-cols-2 items-center gap-8 mb-16 max-w-7xl mx-auto">
        <div className="flex flex-col justify-center w-full md:ml-[-40px] order-2 md:order-1">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-default text-gray-800 mb-4">
            Real-Time{" "}
            <span className="text-orange-500">Team Collaboration</span>
          </h2>
      ...
      <div className="grid md:grid-cols-2 items-center gap-10 md:gap-24 mb-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col justify-center w-full md:mb-[100px] md:ml-[30px]">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-default text-gray-800 mb-4 md:mt-16">
            Insightful{" "}
