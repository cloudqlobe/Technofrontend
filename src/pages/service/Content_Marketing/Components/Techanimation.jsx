...
import image2 from '../../../../assets/Image/robottech.png';
...
return (
  <div className="bg-blue-900 text-white min-h-screen py-16 px-6 md:px-20 overflow-hidden">
    <div className="max-w-7xl mx-auto space-y-16">
      
      {/* Top Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center lg:ml-[-45px]">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold text-yellow-400 mb-4">
            Empower Your Business with Tech Consultancy
          </h2>

          <p className="text-white mt-6 leading-relaxed text-lg text-justify">
      ...
      {/* Bottom Section */}
      <div className="bg-blue-800 p-6 sm:p-8 md:p-10 rounded-xl w-full min-[1410px]:w-[1350px] min-[1410px]:ml-[-40px] mx-auto">
        <h3 className="text-2xl font-semibold text-yellow-400 text-center mb-8">
          Our Services
        </h3>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 sm:gap-8 justify-items-center">
          {techIcons.map((tech, index) => (
            <div
              key={index}
              className="bg-blue-900 p-4 rounded-lg flex flex-col items-center border border-yellow-400 shadow-md hover:shadow-lg transition duration-300 w-full max-w-[220px]"
            >
