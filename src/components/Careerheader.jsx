...
const Careerheader = () => {
  return (
    <div className="bg-white py-12 sm:py-16 lg:py-20 px-6 sm:px-12">
      <div className="max-w-7xl min-h-[440px] mx-auto flex flex-col min-[1500px]:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full max-w-xl mx-auto text-center mt-0 min-[1500px]:mx-0 min-[1500px]:text-left min-[1500px]:mt-[-200px] min-[1500px]:ml-[-50px]">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-4 justify-center min-[1500px]:justify-start">
            <motion.button 
              whileHover={{ scale: 1.05 }} 
              whileTap={{ scale: 0.95 }} 
              className="bg-orange-500 text-white px-6 sm:px-7 py-3 squared-lg text-base sm:text-lg font-semibold hover:bg-orange-600 transition w-full sm:w-auto"
            >
              View Open Roles
            </motion.button>
            <motion.button 
              whileHover={{ scale: 1.05 }} 
              whileTap={{ scale: 0.95 }} 
              className="border border-gray-500 text-gray-900 px-6 sm:px-7 py-3 squared-lg text-base sm:text-lg font-semibold hover:bg-gray-300 transition w-full sm:w-auto"
            >
              Life at Codo Stack
            </motion.button>
          </div>
        ...
        {/* Right Side (Boxes) - Hidden on mobile/tablet, visible on large screens */}
        <div className="relative w-[450px] h-[450px] ml-[100px] hidden min-[1500px]:block">
          ...
          <div className="absolute w-[60px] h-[60px] top-[0px] left-[160px] squared-md shadow-md border border-gray-800 flex items-center justify-center"
               style={{ background: 'rgb(25, 86, 117)' }}>
            <DiRuby className="text-white w-[30px] h-[30px]" />
          </div>

          <div className="absolute w-[93px] h-[95px] top-[140px] left-[325px] squred-md shadow-md flex items-center justify-center"
               style={{ background: 'rgb(54, 117, 136)' }}>
          ...
          <div className="absolute w-[90px] h-[90px] top-[190px] left-[180px] squared-md shadow-md flex items-center justify-center"
          ...
          <div className="absolute w-[80px] h-[80px] top-[-20px] left-[260px] squared-md flex items-center justify-center"
