...
const Crmcontent = () => {
  return (
    <div className="min-h-screen w-full bg-white px-4 sm:px-8 lg:px-12 py-10 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 mb-12 max-w-7xl mx-auto md:mt-[-30px]">
        <div className="relative flex justify-center items-center w-full p-2 md:order-1">
          <img
            ...
            className="w-full max-w-[400px] sm:max-w-[500px] md:w-[600px] h-auto md:h-[600px] object-cover rounded-lg md:ml-[-120px] md:mt-[20px]"
          />
        </div>
        <div className="flex flex-col justify-center w-full md:w-[600px] md:ml-[57px] md:order-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 mb-10 max-w-7xl mx-auto mt-8 md:mt-[60px]">
        ...
        <div className="flex flex-col justify-center w-full md:ml-[-40px] md:order-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-24 mb-12 max-w-7xl mx-auto mt-8 md:mt-[100px]">
        <div className="relative flex justify-center items-center w-full p-2 md:order-1">
          <img
            src={image6}
            alt="Custom CRM Solutions"
            className="w-full max-w-[400px] sm:max-w-[500px] md:w-[700px] h-auto md:h-[700px] object-cover md:mt-[-100px] md:ml-[-100px]"
          />
        </div>
        <div className="flex flex-col justify-center w-full md:mb-[100px] md:ml-[30px] md:order-2">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-default text-grey-200 mt-4 md:mt-[30px]">
