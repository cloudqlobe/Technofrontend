...
import logo from "../../../assets/Image/11563094.png";
      ...
      <div className="flex flex-col lg:flex-row items-center w-full gap-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left lg:ml-[-45px]">
          ...
          <p className="text-white mt-6 leading-relaxed text-base sm:text-lg text-justify">
            ...
            comprehensive digital solutions tailored for the future. From robust
            cybersecurity to scalable hosting services, we manage every aspect
            of your digital infrastructure. With our all-in-one service model,
            you gain reliability, innovation, and a strategic edge — all from one
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          <img
            src={logo}
            alt="Illustration"
            className="w-[260px] sm:w-[320px] lg:w-[500px] object-contain"
          />
        </div>
      </div>
