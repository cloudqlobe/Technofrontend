...
const iconData = [
  { Icon: FaReact, bgColor: "bg-blue-700" },
  { Icon: FaNodeJs, bgColor: "bg-green-700" },
  { Icon: FaPython, bgColor: "bg-yellow-600" },
  { Icon: FaJava, bgColor: "bg-red-700" },
  { Icon: FaRust, bgColor: "bg-orange-700" },
  { Icon: FaDatabase, bgColor: "bg-gray-800" },
  { Icon: SiMongodb, bgColor: "bg-green-700" },
  { Icon: SiExpress, bgColor: "bg-black" },
  { Icon: FaDocker, bgColor: "bg-blue-700" },
  { Icon: FaMagento, bgColor: "bg-red-800" },
  { Icon: FaAws, bgColor: "bg-yellow-600" },
  { Icon: FaGoogle, bgColor: "bg-red-600" },
];
        ...
        >
          ...
          <form className="flex flex-col space-y-3" onSubmit={handleSubmit}>
            <input
              ...
              className="p-3 border border-gray-300 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600" required
            />
            ...
            <input
              ...
              className="p-3 border border-gray-300 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600" />
            ...
            <button
              type="submit"
              className="bg-blue-700 text-white py-3 text-lg font-semibold hover:bg-blue-800 transition shadow-md"
            >
              Submit
            </button>
