...
import image1 from '../assets/Image/6548442.jpg';
import image2 from '../assets/Image/10286772.jpg';
...
const Botcontents1 = () => {
  return (
    <div className="min-h-screen w-full bg-white px-4 sm:px-6 md:px-12 py-10 overflow-hidden">
      ...
      {/* Section 1 - Text left on desktop, but image on top for mobile */}
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 max-w-7xl mx-auto mt-10">
        ...
        <div className="flex flex-col justify-center w-full md:pr-6 order-2 md:order-1">
          ...
          <p className="text-gray-600 text-base sm:text-lg text-justify mt-[30px] leading-relaxed">
      ...
      {/* Section 2 - Image left on desktop, top on mobile */}
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 max-w-7xl mx-auto mt-16">
        ...
        <div className="flex flex-col justify-center w-full md:pl-6 order-2 md:order-2">
